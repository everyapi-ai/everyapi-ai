...
var commands = []command{
	...
	{name: "vm", desc: "Manage repository-owned VM recipes and runtimes", cliOnly: true, run: workspacecmd.Command("vm"), subs: []subcommand{
		{name: "recipe list", desc: "List repository VM recipes", args: []string{"recipe", "list"}},
		{name: "recipe doctor", desc: "Validate a VM recipe", args: []string{"recipe", "doctor"}},
		{name: "runtime list", desc: "List lifecycle-managed VM runtimes", args: []string{"runtime", "list"}},
		{name: "runtime show", desc: "Show one VM runtime", args: []string{"runtime", "show"}},
		{name: "runtime create", desc: "Provision a VM runtime", args: []string{"runtime", "create"}},
