...
func writeCodexConfigTOML(codexHome, apiBase string) error {
	...
	// TOML built by string concat — small and shape-stable, not
	// worth dragging in a TOML writer dep just for two stanzas.
	// apiBase from credentials.json has no quotes; if it ever does
	// they'd be a config corruption upstream of us, not something to
	// hide.
