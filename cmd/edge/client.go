...
// subcommand starts with. Mirrors cmd/seller's sellerClient — keeping
// the shape consistent so a future helper extraction is mechanical.
...
// pointing a dev machine at a staging or local gateway without
// changing the SDK base.
